...
namespace PartyStarter
{
    ...
    public class ApplicationUserManager : UserManager<ApplicationUser,Guid>
    {
        ...
        {
            var manager = new ApplicationUserManager(new UserStore<ApplicationUser,GuidIdentityRole,Guid,GuidIdentityUserLogin,GuidIdentityUserRole,GuidIdentityUserClaim>(context.Get<ApplicationDbContext>()));
